ScriptInfo_backup_nvram_raw_functions() {
...
# General Usage: backupFiles "backup_task_name" "backup_destination_directory" "backup_destination_filename_prefix" "backup_note" "backup_destination_filename_suffix" "backup_retention_number"
# =================================================================================================
# Notes:
#	Uses Color Functions Script (source /.../color_text_functions.sh)
# =================================================================================================
# Check if this script is already loaded
if [ -z $script_loaded_backup_nvram_raw_functions ]; then
	# Output Script Title
	ScriptInfo_backup_nvram_raw_functions
	...
	{ # backupNVRamRAW "backup_task_name" "backup_destination_directory" "backup_destination_filename_prefix" "backup_destination_filename_suffix" "backup_retention_number" "backup_note"
		...
		backup_task_name="Backup NVRam (RAW Configuration)"
		...
		# [# Output Task #]
		BRK 2
		WHT "Backup NVRam (RAW Configuration) Task: $backup_task_name ($backup_note)"
		...
		# Copy File
		NRM "Saving NVRam: $(BLK "NVRam") -> $(BLK "$backup_destination_path")"
	...
	script_loaded_backup_nvram_raw_functions=true
fi