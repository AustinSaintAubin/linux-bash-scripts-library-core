# RSSDowner - RSS Feeds Downloader Script 2011/02/25 v2.2 By: Austin Saint Aubin
# sh $(nvram get usb_disk_main)/Tomato/RSSDowner.sh
# ============================================================================
...
# DownThis( Name, URL, DIR, SubDIR, XFilter  )
DownThis()
{
	logIt "URL: $2"
	fileName=$(basename $2)
...
logIt "   /!\\ Sequential duplicate found in feed, skipping it. /!\\"
fi
logIt "~ - - - - - - - - - - - - - - - - - - - - - - - - - - - ~"
done
